<table class="table table-bordered table-hover">
    ...
    <?php   
        ...
        //$query = "SELECT * FROM quickreports WHERE reply_complaint_reporter = '$the_user'";
        ...
        echo "<td><a onClick=\"javascript: return confirm('Are you sure you want to verify?'); \" href='quickreports.php?verify={$qr_id}'>Verify</a></td> ";

        echo "<td class='bg-success'>{$qr_timestamp}</td> ";
